...
ActiveRecord::Schema.define(version: 20180713212010) do
  ...
  create_table "deliveries", force: :cascade do |t|
    ...
    t.index ["message_id", "user_id"], name: "index_deliveries_on_message_id_and_user_id", using: :btree
